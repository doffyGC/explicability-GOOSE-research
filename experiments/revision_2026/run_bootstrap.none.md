...
- Generated: 2026-09-13 07:06:36 UTC
...
|---|---|---:|---|---|
| `d3-decision-tree-none` | `d3-xgboost-none` | +0.0032 | [+0.0011, +0.0060] | **yes** |
| `d3-decision-tree-none` | `d3-random-forest-none-cap4m` | +0.0385 | [+0.0329, +0.0442] | **yes** |
| `d3-decision-tree-none` | `d3-logistic-regression-none` | -0.1142 | [-0.1272, -0.0991] | **yes** |
| `d3-decision-tree-none` | `d3-decision-tree-none-cap4m` | -0.0002 | [-0.0005, +0.0000] | no - indistinguishable |
| `d3-decision-tree-none` | `grouped-validation-full-smote` | -0.0085 | [-0.0126, -0.0047] | **yes** |
